...
import ie.wit.chatup.WelcomeActivity
import com.google.firebase.auth.FirebaseAuth
import com.google.firebase.auth.FirebaseUser
import com.squareup.picasso.Picasso
import com.google.firebase.database.FirebaseDatabase
import de.hdodenhof.circleimageview.CircleImageView
import ie.wit.chatup.ViewFullImageActivity
...
) : RecyclerView.Adapter<ChatsAdapter.ViewHolder?>()
{
    ...
    override fun onCreateViewHolder(parent: ViewGroup, position: Int): ViewHolder
    {
        ...
        {
            val view: View = LayoutInflater.from(mContext).inflate(ie.wit.chatup.R.layout.message_item_right, parent, false)
            ViewHolder(view)
        }
        else
        {
            val view: View = LayoutInflater.from(mContext).inflate(ie.wit.chatup.R.layout.message_item_left, parent, false)
            ViewHolder(view)
        }
    }
